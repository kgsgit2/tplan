-- =====================================================
-- TPlan Database Schema v1.0 - Complete Migration
-- =====================================================
-- Execute this in Supabase SQL Editor
-- This migration sets up the complete database architecture
-- for the travel planning application
-- =====================================================
...
-- Plan items (activities in trips)
...
-- =====================================================
-- SECTION 4: SYNC & COLLABORATION TABLES
-- =====================================================
...
-- =====================================================
-- SECTION 9: DEVELOPMENT POLICIES
-- =====================================================
...
DROP POLICY IF EXISTS "Allow anonymous write for development" ON trips;
CREATE POLICY "Allow anonymous write for development" ON trips
    FOR INSERT WITH CHECK (true);

DROP POLICY IF EXISTS "Allow anonymous update for development" ON trips;
CREATE POLICY "Allow anonymous update for development" ON trips
...
DROP POLICY IF EXISTS "Allow anonymous write for development" ON plan_items;
CREATE POLICY "Allow anonymous write for development" ON plan_items
    FOR INSERT WITH CHECK (true);

DROP POLICY IF EXISTS "Allow anonymous update for development" ON plan_items;
CREATE POLICY "Allow anonymous update for development" ON plan_items
    FOR UPDATE USING (true);

DROP POLICY IF EXISTS "Allow anonymous delete for development" ON plan_items;
CREATE POLICY "Allow anonymous delete for development" ON plan_items
